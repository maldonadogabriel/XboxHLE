...
namespace xboxhle
{
    class i386
    {
        ...
        // stack registers
        public static Int16[] word = new Int16[0x00FFFFFF];
            ...
            switch ((reg32_eip << 0) & 0xFF)
            {
                ...
                case 0x8B:
                    ...
                    else if (((reg32_eip & 0x0000FF00) >> 8) == 0x45)
                    {
                        ...
                        reg32_eax = dword[/*reg32_ebp + offset*/ 0]; // needs checking moves color to eax
                        reg32_pc += 3;
                    }
                ...
                case 0xE8:
                    ...
                    if ((((reg32_eip & 0x0000FF00) >> 8)) == 0x95)
                    {
                        ...
                        reg32_esp = reg32_esp + 1;
                        offset = (Int32)((reg32_eip & 0xFFFFFFFF00) >> 8);
                        reg32_pc = reg32_pc - Math.Abs(offset) + 5;
                    }
                    break;
                case 0x81:
                    // add esp, valh
